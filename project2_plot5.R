...
lookupbalt <- sourcesPM25[grep("Coal", sourcesPM25$SCC.Level.Three),]
...
plot(coalTotalbalt$year, coalTotalbalt$count, type = "l", main = "Coal combustion sources in Baltimore City", ylab = "PM25 Emissions (tons)", xlab = "")
